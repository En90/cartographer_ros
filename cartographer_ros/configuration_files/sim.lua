...
POSE_GRAPH.constraint_builder.sampling_ratio = 0.3 --0.3 --0.35
POSE_GRAPH.optimization_problem.ceres_solver_options.max_num_iterations = 50
POSE_GRAPH.constraint_builder.min_score = 0.56 --0.6 --0.62
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.6 --0.65 --0.66
POSE_GRAPH.constraint_builder.max_constraint_distance = 20
POSE_GRAPH.global_sampling_ratio = 0.0025 --0.0025 --0.005
...
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.linear_xy_search_window = 3 --3
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.linear_z_search_window = 0.3
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.angular_search_window = math.rad(12.) --15
