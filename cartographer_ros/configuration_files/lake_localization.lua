...
POSE_GRAPH.constraint_builder.sampling_ratio = 0.2 --0.28
POSE_GRAPH.optimization_problem.ceres_solver_options.max_num_iterations = 60 --40
POSE_GRAPH.constraint_builder.min_score = 0.56 --0.52
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.58 --0.5
POSE_GRAPH.constraint_builder.max_constraint_distance = 10 --20
POSE_GRAPH.global_sampling_ratio = 0.002 -- 0.0025
...
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.min_rotational_score = 0.66
