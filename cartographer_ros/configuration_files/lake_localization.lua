...
TRAJECTORY_BUILDER_3D.max_range = 20 --15
...
POSE_GRAPH.constraint_builder.min_score = 0.5 --0.52
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.42 --0.5
POSE_GRAPH.constraint_builder.max_constraint_distance = 10 --20
POSE_GRAPH.global_sampling_ratio = 0.001 -- 0.0025
...
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.linear_z_search_window = 0.15
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.angular_search_window = math.rad(15.)
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.min_rotational_score = 0.68
