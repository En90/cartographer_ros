...
TRAJECTORY_BUILDER_3D.submaps.num_range_data = 170
-- TRAJECTORY_BUILDER_3D.high_resolution_adaptive_voxel_filter.min_num_points = 60
-- TRAJECTORY_BUILDER_3D.high_resolution_adaptive_voxel_filter.max_range = 5
...
POSE_GRAPH.global_sampling_ratio = 0.04 --0.05
-- POSE_GRAPH.optimize_every_n_nodes = 200
POSE_GRAPH.constraint_builder.sampling_ratio = 0.025 --0.03
